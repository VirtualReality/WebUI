...
$webui_login='Connection';
$webui_confirm='Confirmer';
$webui_start_region='Région de départ';
$webui_address='Adresse';
$webui_zip_code='Code Zip';
$webui_city='Ville';
$webui_country='Pays';
...
$webui_location='Lieu';
$webui_info='Info';
$webui_regions_found='Régions trouvées';
$webui_region_list='Liste des régions';
$webui_more_info='Plus d\'info';
$webui_region_list_page_info='Ceci est la liste des régions, cliquez sur \''.$webui_more_info.'\' pour obtenir plus d\'informations sur cette région.';
...
// Online Users Page
//
$webui_online_users='Utilisateurs en Ligne';
$webui_online_users_info='Ceci affiche tous les utilisateurs en ligne en ce moment.';

$webui_submit='Soumettre';
$webui_verified_account='Merci, votre compte est maintenant prêt à l\'emploi.';
$webui_internal_error='Erreur interne, s\'il vous plaît réessayer à nouveau plus tard.';
$webui_invalid_code='Ce n\'est pas un code valide ou peut-être que le code est de plus de 24h';
$webui_activate_account='Activer le compte';
$webui_change_account='Changer de Compte';
$webui_change_password='Changer le mot de passe';
$webui_old_password='Ancien mot de passe';
$webui_change_email='Changer l\'adresse Email';
$webui_old_email='Ancienne adresse Email';
$webui_new_email = 'Nouvelle adresse Email';
$webui_change_name='Changer le nom';
$webui_login='Connection';
$webui_register='Inscription';
...
// User Profil Page
//
$webui_see_profile='Voir le Profile';
$webui_users_profile='Profil de';
$webui_no_information_set="Aucune information";
...
$webui_owner="Propriétaire";

//
// Menu items
//
$webui_menu_item_home = 'Accueil';
$webui_menu_item_changeaccount = 'Modifier';
$webui_menu_item_news = 'Nouveautés';
$webui_menu_item_regions = 'Régions';
$webui_menu_item_worldmap = 'Carte du monde';
...
$webui_menu_item_chat = 'Chat Support';
$webui_menu_item_downloads = 'Téléchargements';
$webui_menu_item_addgrid = 'Ajouter Grille';
$webui_menu_item_addserver = 'Ajouter Server';
...
// 404 page
//
$webui_404_text = 'La page demandée n\'a pas pu être trouvée! S\'il vous plaît réessayer plus tard.';
$webui_404_title = 'Erreur 404';
$webui_404_gohome = 'Retour à l\'accueil';
...
$webui_old_password = 'Ancien mot de passe';
$webui_new_password = 'Nouveau mot de passe';
$webui_confirm_password = 'Confirmer le mot de passe';
...
$webui_admin_grid_status = 'Status Grille';
$webui_admin_windows_status = 'Status Fenêtre';
$webui_admin_windows_color = 'Couleur Fenêtre';
$webui_admin_windows_title = 'Titre Fenêtre';
...
//
$webui_admin_manage = 'Panneau d\'administrations';
...
$webui_admin_manage_userban = 'Bannir cet utilisateur';
...
$webui_admin_edit_manage_avatar_name = 'Nom de Avatar';
$webui_admin_edit_manage_real_name = 'Nom réel';
